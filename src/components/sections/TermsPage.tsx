...
const content = {
  ...
  ar: {
    ...
    sections: [
      {
        heading: 'قبول الشروط',
        text: 'باستخدام موقع الوحيد للاحذية وخدماته، فإنك توافق على الالتزام بشروط الخدمة هذه. إذا لم توافق على هذه الشروط، يرجى عدم استخدام موقعنا أو خدماتنا.',
      },
      {
        heading: 'المنتجات والخدمات',
        text: 'تصنع وتوفر شركة الوحيد للاحذية منتجات أحذية تشمل الأحذية الكاجوية والرياضية والرسمية وأحذية السلامة والشباشب والبوت. صور المنتجات والأوصاف على هذا الموقع لأغراض مرجعية فقط.',
      },
      {
      ...
      {
        heading: 'الضمان',
        text: 'توفر شركة الوحيد للاحذية ضمان الجودة لجميع المنتجات المصنعة. تحدد شروط الضمان في اتفاقيات التصنيع الفردية وتشمل عيوب المواد والصناعة في ظروف الاستخدام العادية.',
      },
      {
        heading: 'حدود المسؤولية',
        text: 'لا تتحمل شركة الوحيد للاحذية المسؤولية عن أي أضرار غير مباشرة أو عرضية أو تبعية الناتجة عن استخدام موقعنا أو منتجاتنا. لا تتجاوز مسؤوليتنا الإجمالية قيمة المنتجات أو الخدمات المعنية.',
      },
      {
