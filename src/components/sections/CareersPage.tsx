...
const values = [
  ...
  },
  {
    titleEn: 'Teamwork',
    titleAr: 'عمل الفريق',
    descriptionEn: 'Our strength lies in our dedicated team of over 120+ skilled professionals committed to excellence.',
    descriptionAr: 'قوتنا تكمن في فريقنا المتفاني المكون من أكثر من 120+ عامل ماهر ومحترف ملتزمين بالتميز.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
