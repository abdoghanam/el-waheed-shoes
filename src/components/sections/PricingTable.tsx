...
const tiers: PricingTier[] = [
  {
    ...
    bestForAr: 'بائعون صغار، متاجر بونتيك',
  },
  {
    tier: 'Business',
    tierAr: 'الأعمال',
    ...
    <section className="py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-gold text-sm font-medium">Pricing</span>
          <h2 className="mt-2 text-3xl sm:text-4xl font-bold text-black">
            MOQ & Pricing Tiers / الحد الأدنى للطلب والأسعار
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {tiers.map((tier, i) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-gold mb-1">{tier.tier}</h3>
              <p className="text-xs text-gray-400 mb-4">{tier.tierAr}</p>

              <div className="mb-4">
                <span className="text-3xl font-bold text-black">{tier.moq}</span>
                <span className="text-sm text-gray-500 ml-1">pairs min</span>
              </div>
              ...
              <p className="text-sm text-gray-500 mb-6 flex-1">{tier.bestFor}</p>
